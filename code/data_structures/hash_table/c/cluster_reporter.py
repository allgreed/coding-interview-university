...
for line in fileinput.input():
    ...
    if "Cluster allert" in line:
        ...
        print("Timing - Best: {0}, medjana: {1}, mean: {2:.2f}, worst: {3}".format(min(operation_timing), statistics.median(operation_timing), statistics.mean(operation_timing), max(operation_timing)))
        print(line)
        cluster_list = [0]
        operation_timing = []
